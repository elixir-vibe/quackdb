defmodule Mix.Tasks.Quackdb.Functions.Snapshot do
  ...
  @skip_reasons %{
    ...
    "bit_and" => "bitwise aggregate; not part of the curated analytical helper surface yet",
    "bit_or" => "bitwise aggregate; not part of the curated analytical helper surface yet",
    "bit_xor" => "bitwise aggregate; not part of the curated analytical helper surface yet",
    "bool_and" => "boolean aggregate; not part of the curated analytical helper surface yet",
    "bool_or" => "boolean aggregate; not part of the curated analytical helper surface yet",
